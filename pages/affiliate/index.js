          ...
          {isForm ? (
            ...
            <div className="terms" dir="rtl">
              ...
              <div className="content">
                <p>
                  الدول المستهدفة لإعلانات نمشي، هي: المملكة العربية السعودية
                  والامارات العربية المتحدة وسلطنة عُمان ومملكة البحرين ودولة
                  الكويت فقط.
                </p>
                <p>
                  {" "}
                  الحد الأعلى للميزانية اليومية: 100 دولار للعرض الإعلاني الواحد
                  خلال اليوم الواحد ووفقا للاتفاق مع مدير حسابك في نمشي (ملاحظة:
                ...
                <ul>
                  ...
                  <li>
                    {" "}
                    التسويق باستخدام كلمة العلامة التجارية الخاصة بنمشي على محركات
                  ...
                  <li>
                    {" "}
                    الإعلان باستخدام شعارات أو صور او تصاميم ليست لنمشي او قد تسيء
                    للعلامة التجارية الخاصة{" "}
                  </li>
                </ul>
                <p>
                  التتبع والدفعات: يتم اعتماد النتائج والارقام الموجودة بنظام نمشي
                ...
                <p>
                  ...
                  الاجتماعي للتسويق لنمشي، إلا إذا كنت أنت من المؤثّرين وتستخدم
