              ...
              <div className="costs">
                <div className="total-bag">
                  ...
                  <span className="amount">
                    {t("sar")} {subTotal ? subTotal : 0}
                  </span>
                </div>
                <div className="tax">
                  <span>{t("tax")} 15% :</span>
                  <span className="amount">
                    {t("sar")} {parseFloat(tax.toFixed(2))}
                  </span>
                </div>
              </div>
            ...
            <div className="bag-products">
              {cartItems.map((item, index) => (
                <ShoppingCard
                  key={index}
                  data={item}
                  deletedProduct={onDeleted}
                />
              ))}
            </div>
          ) : (
            <div className="bag-text-center">
              {t("message.no_products_shopping_bag")}
            </div>
          )}
        </div>
      </section>
